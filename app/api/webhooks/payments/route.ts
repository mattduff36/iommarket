...
async function submitPaidListingForReview(listingId: string, event: NormalizedProviderWebhookEvent) {
...
async function upsertDealerSubscription(
  event: NormalizedProviderWebhookEvent,
  ...
  try {
    switch (event.type) {
      ...
      case "subscription.updated":
        await upsertDealerSubscription(
          event,
          mapSubscriptionStatus(event.subscriptionStatus)
        );
        break;
